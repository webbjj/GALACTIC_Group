...
plt.savefig('Comparsion of escaper masses (1000 stars, M92).png')
plt.show()
...
plt.ylabel("Normalized Counts", fontsize=13)
plt.legend(fontsize=10)
plt.savefig('Comparsion of binary and triple masses (1000 stars, M92).png')
plt.show()
...
plt.ylabel("Normalized Counts", fontsize=13)
plt.legend(fontsize=10)
plt.savefig('Comparison of single\'s escape velocity (1000 stars, M92).png')
plt.show()
...
plt.ylabel("Normalized Counts", fontsize=13)
plt.legend(fontsize=10)
plt.savefig('Comparison of binaries and triples escape velocities (1000 stars, M92).png')
plt.show()
